...
def faceDetection(test_img):
    ...
    face_haar=cv2.CascadeClassifier(r'C:\Users\PRANAY\AppData\Local\Programs\Python\Python38-32\models\object detection\haarcascade_frontalface_alt.xml')
...
def labels_for_training_data(directory):
    ...
    for path,subdrinames,filenames in os.walk(directory):
